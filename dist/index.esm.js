...
var shadows = {
    ...
    active: "0px 0px 0px 1px #FB5230, 0px 0px 4px 8px #FB523066",
    success: "0px 0px 0px 1px #42ba96, 0px 0px 0px 4px #42ba9633",
    warning: "0px 0px 0px 1px #ED4B9E, 0px 0px 0px 4px rgba(237, 75, 158, 0.2)",
    focus: "0px 0px 0px 1px #330099, 0px 0px 0px 4px #33009999",
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#a6a9e4", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#ce492e", textDisabled: "#BDC2C4", textSubtle: "#c45f4b", disabled: "#E9EAEB", gradients: {
        bubblegum: "linear-gradient(139.73deg, #d64325 0%, #7436f1 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #7436f1 0%, #d64325 100%)",
        cardHeader: "linear-gradient(111.68deg, #a6a9e4 0%, #e26046 100%)",
        blue: "linear-gradient(180deg, #c55943 0%, #fa856e 100%)",
        violet: "linear-gradient(180deg, #E2C9FB 0%, #CDB8FA 100%)",
        violetAlt: "linear-gradient(180deg, #CBD7EF 0%, #9A9FD0 100%)",
        gold: "linear-gradient(180deg, #FFD800 0%, #FDAB32 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#4A0096", background: "#202136", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#FB5230", tertiary: "#353547", text: "#e47e6a", textDisabled: "#666171", textSubtle: "#b85f4d", disabled: "#524B63", gradients: {
        bubblegum: "linear-gradient(139.73deg, #4A0096 0%, #af4a35 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #af4a35 0%, #4A0096 100%)",
        cardHeader: "linear-gradient(166.77deg, #3B4155 0%, #3A3045 100%)",
        blue: "linear-gradient(180deg, #fa856e 0%, #df6249 100%)",
